...
const Navbar = () => {
  ...
  return (
    ...
    <div className='fixed w-full h-20 flex justify-between items-center px-4 bg-slate-900 text-gray-300'>
	  ...
	  <li>
           <Link to='work' smooth={true} duration={500} className="cursor-pointer hover:text-white">
            Projects
           </Link>
	  </li>
	   <li>
      ...
      <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
        <ul>
         ...
         <li className='w-40 h-14 flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#333]'>
      		<a href="https://github.com/Mdoughty-dev" className='flex justify-between items-center w-full text-gray-300 px-4' target="_blank" rel="noreferrer">
